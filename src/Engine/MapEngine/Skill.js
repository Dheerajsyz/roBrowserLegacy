...
define(function( require )
{
	...
	*/
	...
	{
		var starTypes = [ 'Sun', 'Moon', 'Stars' ];
		var starType  = starTypes[ pkt.which ] || 'Sun';
		var mapName   = DB.getMapName( MapRenderer.currentMap, MapRenderer.currentMap );
		...
		UIManager.showPromptBox(
			...
			'cancel',
			function() {
				var response  = new PACKET.CZ.AGREE_STARPLACE();
