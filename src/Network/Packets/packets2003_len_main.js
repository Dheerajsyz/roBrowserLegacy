/**
 * Network/Packets/packets2003_len_main.js
 *
...
function init(packetver) {
	...
	} else if (packetver >= 20031110) {
		length_list[0x00f9] = 28;
	} else if (packetver >= 20031028) {
		length_list[0x00f9] = 26;
	}
	...
	if (packetver >= 20031117) {
		...
		// removed
	} else if (packetver >= 20031103) {
		length_list[0x01e9] = 2;
	}
	...
	if (packetver >= 20031223) {
		...
		// Packet: 0x0219 - ZC_BLACKSMITH_RANK
		length_list[0x0219] = 282;

		// Packet: 0x021a - ZC_ALCHEMIST_RANK
		length_list[0x021a] = 282;

		// Packet: 0x021b - ZC_BLACKSMITH_POINT
		length_list[0x021b] = 10;

		// Packet: 0x021c - ZC_ALCHEMIST_POINT
		length_list[0x021c] = 10;

		// Packet: 0x021f - ZC_NOTIFY_PKINFO
		length_list[0x021f] = 66;

		// Packet: 0x0224 - ZC_TAEKWON_POINT
		length_list[0x0224] = 10;

		// Packet: 0x0226 - ZC_TAEKWON_RANK
