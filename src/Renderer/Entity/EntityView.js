...
define(function( require )
{
	...
	var AllMountSet = (function() {
		var set = {};
		for (var k in AllMountTable) {
	...
	function UpdateBodyPalette( pal )
	{
		...
		var palJob = this.costume || this._job;
		this.files.body.pal = DB.getBodyPalPath( palJob, this._bodypalette, this._sex);
	}
